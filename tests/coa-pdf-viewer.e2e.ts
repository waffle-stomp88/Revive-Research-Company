 ...
 *
 * Worker context:
 *   pdfjs-dist ≥ 5 requires several APIs (URL.parse, Promise.try,
 *   Promise.withResolvers, Uint8Array.prototype.toHex,
 *   Map.prototype.getOrInsertComputed) that landed in Chrome 126–136.
 *   playwright.config.ts uses Playwright's bundled Chromium (≥ 147) which
 *   ships all five APIs natively — no compatibility shims needed.
 *
