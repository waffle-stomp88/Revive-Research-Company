...
export default function LabNotes() {
  return (
    <main className="min-h-screen pt-32 md:pt-40 pb-24">
      <SEOHead title="Research Archive" description="Technical research updates and compound insights. Stay informed with our scientific archive." canonicalPath="/lab-notes" />
