...
export default function BulkPacks() {
  ...
  return (
    <>
      ...
      <SEOHead title="Bulk Packs" description="Save on larger quantities of research peptides. Bulk pricing for serious researchers." canonicalPath="/bulk-packs" />
              ...
              {inStockProducts.map((product) => {
                ...
                return (
                  <motion.div key={product.id} {...fadeInUp}>
                    <Card 
                      className="group p-4 cursor-pointer transition-all duration-300 border-2 border-[#21d8ff]/40 md:hover:border-[#21d8ff] md:hover:shadow-[0_0_30px_rgba(33,216,255,0.3)] md:hover:scale-[1.02] md:active:scale-[1.02]"
                    ...
                    >
                      <div className="relative aspect-square bg-gradient-to-br from-muted to-muted/50 rounded-lg mb-3 overflow-hidden">
                        <img
                          ...
                          className="w-full h-full object-contain p-3 md:group-hover:scale-105 md:group-active:scale-105 transition-transform"
                        />
