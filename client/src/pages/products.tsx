...
const peptideGroups = [
  ...
  { id: "hormonal", label: "Hormonal", color: "#a855f7", names: ["hcg", "gonadorelin", "oxytocin", "kisspeptin", "pt-141", "triptorelin", "alprostadil"] },
                          ...
                          return (
                            ...
                            >
                              ...
                              <div className="flex-1 flex flex-col min-h-0">
                                ...
                                <h3 className="font-display sm:text-[25px] font-black mb-0.5 md:group-hover:text-[#E7FB10] transition-colors line-clamp-2 text-center text-[28px]">
                                  {product.name}
                                </h3>
