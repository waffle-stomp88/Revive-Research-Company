...
function SavingsCalculator() {
  ...
  return (
    <Card className="p-6 md:p-8 border-2 border-[#21d8ff]/30 bg-gradient-to-br from-[#21d8ff]/5 to-transparent">
      ...
      <div className="space-y-6">
        ...
        <div className="p-4 rounded-xl bg-gradient-to-r from-[#21d8ff]/20 to-[#22c55e]/20 border border-[#21d8ff]/30">
