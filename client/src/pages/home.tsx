  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-background">
      ...
      >
        ...
        >
          <Link href="/products">
            <Button size="lg" className="font-display text-base px-8 gap-2" data-testid="button-hero-shop">
              Shop Products
            ...
            {featuredProducts.map((product) => (
              ...
              >
                <Link href={`/products/${product.id}`}>
                  <Card className="group p-8 hover-elevate cursor-pointer transition-all duration-300" data-testid={`card-product-${product.id}`}>
