    ...
    <section className="py-16 md:py-24 bg-gradient-to-b from-background via-[#21d8ff]/5 to-background">
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-8 md:gap-12">
          ...
          >
            <Card className="h-full border-2 border-[#21d8ff]/50 bg-gradient-to-br from-[#21d8ff]/10 to-transparent transition-all duration-300 overflow-visible" style={{ boxShadow: '0 0 25px rgba(33, 216, 255, 0.25), inset 0 0 20px rgba(33, 216, 255, 0.05)', animation: 'pulse-glow-cyan 3s ease-in-out infinite' }}>
          ...
          >
            <Card className="h-full border-2 border-[#9d4edd]/50 bg-gradient-to-br from-[#9d4edd]/10 to-transparent transition-all duration-300 overflow-visible" style={{ boxShadow: '0 0 25px rgba(157, 78, 221, 0.25), inset 0 0 20px rgba(157, 78, 221, 0.05)', animation: 'pulse-glow-purple 3s ease-in-out infinite' }}>
              <div className="p-6 md:p-8">
                <div className="flex flex-col items-center gap-4 mb-6 text-center">
