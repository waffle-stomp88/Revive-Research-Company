...
export default function WhatWeDontDo() {
  return (
    <main className="min-h-screen pt-32 md:pt-40 pb-24">
      <SEOHead title="What We Don't Do" description="Learn what sets us apart. Our commitment to quality, transparency, and ethical research practices." canonicalPath="/guides/peptide-vendor-ethics-standards" />
