    ...
    <main className="min-h-screen pt-32">
      ...
      <section className="relative pb-16 md:pb-20 overflow-hidden">
        ...
        <div className="container max-w-4xl mx-auto px-4 relative z-10 text-center">
          ...
          >
            Everything you need to understand peptide research, verification, and compliance.
          </motion.p>
        </div>
      </section>
                  ...
                  <Link href={resource.href} onClick={() => window.scrollTo(0, 0)}>
                    ...
                    >
                      <Card 
                        ...
                        data-testid={`card-resource-${resource.title.toLowerCase().replace(/\s+/g, "-").replace(/&/g, "and")}`}
                      >
                        <div
                        ...
                        <h3 className="text-lg font-semibold mb-2 relative z-10" data-testid={`text-resource-${resource.title.toLowerCase().replace(/\s+/g, "-").replace(/&/g, "and")}`}>
                          {resource.title}
                        </h3>
