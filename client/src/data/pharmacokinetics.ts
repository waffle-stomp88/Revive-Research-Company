...
export const PEPTIDE_HALF_LIVES: HalfLifeEntry[] = [
  ...
  },
  {
    ...
    citations: [pmid("12374906", "Khavinson (2002) — Peptides and Ageing, Neuro Endocrinol Lett [off-compound proxy: multi-peptide bioregulatory review, not Epithalon-specific PK data]")],
  ...
  },
  {
    ...
    citations: [pmid("9637345", "Morozov & Khavinson (1997) — Natural and synthetic thymic peptides as therapeutics for immune dysfunction, Int J Immunopharmacol [off-compound proxy: thymic peptide class review, not thymalin-specific PK data]")],
  ...
  },
  {
    ...
    citations: [pmid("26052837", "Zhou et al. (2015) — Intravenous N-acetylcysteine and indirect glutathione pharmacokinetics and redox status, J Pharm Sci [off-compound proxy: N-acetylcysteine / GSH precursor, not free glutathione itself]")],
    citationQuality: "class-proxy",
  ...
  },
  {
    ...
    note: "No compound-specific PubMed-indexed SC pharmacokinetics study for VIP was identified (May 2026 audit; confirmed null result). The ~10–30 min SC window is estimated using two published inhaled VIP human studies as the closest available non-IV absorption proxy: Barnes PJ & Dixon CM (1984, PMID 6465669, Am Rev Respir Dis) and Bundgaard et al. (1983, PMID 6578098, Eur J Respir Dis Suppl). IMPORTANT LIMITATION — plasma VIP concentrations audit (May 2026): A dedicated PubMed search was conducted using the strategy '(\"vasoactive intestinal peptide\" OR VIP) AND (inhaled OR inhalation OR aerosol) AND (\"plasma concentration\" OR pharmacokinetics OR \"half-life\" OR bioavailability OR absorption)' to identify any inhaled VIP study that directly measured plasma VIP concentrations. No such study was found. Neither Barnes & Dixon (1984, PMID 6465669) nor Bundgaard et al. (1983, PMID 6578098) measured plasma VIP concentrations after inhalation — both studies measured airway functional outcomes (bronchial reactivity to histamine challenge, exercise-induced bronchoconstriction protection) and haemodynamic endpoints. The proxy reasoning therefore rests entirely on indirect evidence: the absence of IV-typical cardiovascular effects (tachycardia, flushing) in both inhaled studies is used as a surrogate marker of absorption-limited systemic entry and consequently prolonged apparent plasma residence relative to the 1–2 min IV half-life. No inhaled VIP human study with direct plasma concentration measurements is available in the published literature as of May 2026; the SC half-life estimate is therefore an inference, not an empirical measurement. PMID correction (May 2026): the SC citations array previously carried PMID 6139325, attributed to Morice et al. (1983, Lancet) as an inhaled-VIP proxy. Verification revealed PMID 6139325 resolves to an unrelated Polish-language obstetrics paper; the correct PMID for Morice et al. (1983, Lancet) is 6139572, and that paper describes an intravenous VIP infusion study (not inhaled). PMID 6139572 (Morice et al. 1983) has been added to the IV altRoute citations array alongside Domschke et al. (1979, PMID 7175453). IV half-life (~1–2 min) is sourced from Domschke et al. (1979, PMID 7175453) and Morice et al. (1983, PMID 6139572), both assigned exclusively to the altRoute IV citations array.",
    altRoute: {
      route: "intravenous",
      halfLifeMin: 1,
      halfLifeMax: 2,
  ...
  // ─── Vitamins / amino acid supplements ───────────────────────────────────────
  {
    ...
    citations: [pmid("39245417", "Hotta & Mano (2024) — Pharmacokinetic profiles of methylcobalamin in rats after multiple administration routes by a simple LC-MS/MS assay, J Pharmacol Toxicol Methods [off-compound proxy: methylcobalamin (active B12 coenzyme form), not cyanocobalamin (the injectable B12 form this entry covers)]")],
    citationQuality: "class-proxy",
