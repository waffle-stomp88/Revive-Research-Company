...
const redoxPhases: RedoxPhase[] = [
  ...
  { id: 1, label: "GSH Defense", icon: Shield, color: "#D4FF1F", description: "Reduced glutathione (GSH) donates electrons to neutralize ROS" },
      ...
      <svg viewBox="0 0 400 220" className="w-full h-full max-w-lg">
        ...
        {activePhase >= 1 && (
          <motion.g>
            ...
            />
            <motion.text x="200" y="60" textAnchor="middle" fill="#D4FF1F" fontSize="8" fontWeight="bold"
              initial={{ opacity: 0 }}
