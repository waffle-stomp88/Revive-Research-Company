  ...
  return (
    <div ref={containerRef} className="relative" data-testid="hpg-axis-restore-synergy-visual">
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse at 40% 30%, rgba(212, 255, 31,0.06) 0%, rgba(244,114,182,0.05) 60%, transparent 100%)",
        }}
      />
      ...
      >
        <div
          ...
          style={{
            background:
              "linear-gradient(135deg, rgba(212, 255, 31,0.12) 0%, rgba(244,114,182,0.08) 100%)",
