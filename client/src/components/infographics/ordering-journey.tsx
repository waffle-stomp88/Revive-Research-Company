    ...
    <div ref={containerRef} className="relative py-12 px-4">
      ...
      >
        ...
        <p className="text-sm text-muted-foreground mb-3">
          <span className="text-[#E7FB10] font-bold">2 business days</span> from checkout to your door with free shipping on orders over <span className="text-[#21d8ff] font-bold">$200</span>
        </p>
