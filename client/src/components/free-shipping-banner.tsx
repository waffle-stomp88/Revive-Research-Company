  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto flex items-center justify-center gap-2 text-sm font-medium">
        ...
        <span>
          <span className="font-bold text-red-600" style={{ animation: 'pulse 2s cubic-bezier(0.4, 0, 0.6, 1) infinite' }}>FREE SHIPPING</span> on orders over ${FREE_SHIPPING_THRESHOLD}
