  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto flex items-center justify-center gap-2 text-sm font-medium">
        ...
        <span>
          <span className="font-bold text-red-600 animate-pulse-subtle" style={{ textShadow: '0 0 8px rgba(239, 68, 68, 0.6)' }}>FREE SHIPPING</span> on orders over ${FREE_SHIPPING_THRESHOLD}
