...
export default {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        "glow-sm": "0px 0px 15px 0px rgba(255, 235, 59, 0.40)",
        "glow-md": "0px 0px 25px 0px rgba(255, 235, 59, 0.50)",
        "glow-lg": "0px 0px 40px 0px rgba(255, 235, 59, 0.60)",
        "glow-xl": "0px 0px 60px 0px rgba(255, 235, 59, 0.70)",
      },
    },
  },
