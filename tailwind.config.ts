  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        "glow-md": "0px 0px 25px 0px rgba(231, 251, 16, 0.50)",
        "glow-lg": "0px 0px 40px 0px rgba(231, 251, 16, 0.60)",
        "glow-xl": "0px 0px 60px 0px rgba(231, 251, 16, 0.70)",
        "glow-red-sm": "0px 0px 15px 0px rgba(239, 68, 68, 0.40)",
